...
root = Path("backend/data/ablations_freeze_cos")
root.mkdir(parents=True, exist_ok=True)
seeds = [42, 43, 44, 45, 46]
rounds = 1000

configs = [
    ("freeze_cos_0.10", ["--tau", "0.5", "--beta", "0.001", "--normalize-features", "--freeze-cos", "0.10"]),
    ("freeze_cos_0.15", ["--tau", "0.5", "--beta", "0.001", "--normalize-features", "--freeze-cos", "0.15"]),
    ("freeze_cos_0.20", ["--tau", "0.5", "--beta", "0.001", "--normalize-features", "--freeze-cos", "0.20"]),
]
